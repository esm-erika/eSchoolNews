...
<?php } ?> 							
        ...
        <div class="row collapse">
          ...
          <div class="sidebar-bg">
					<h3><img class="left" style="max-width: 30px; margin-right: 5px;" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/lightbulb-science.png"> Insights &amp; Resources</h3>

					<article>
                <h5>Ed-Tech Point of View: <br>Transforming Science Education for a Digital Era</h5>
						<div class="row">
							<div class="small-12 medium-6 columns">
