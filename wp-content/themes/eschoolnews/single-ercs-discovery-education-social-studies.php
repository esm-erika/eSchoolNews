...
<?php } ?> 					
              ...
              <span class="micro-menu">
							<span class="active"><strong>> RESOURCES:</strong> <a href="<?php home_url(); ?>/ercs/discovery-education-social-studies">SOCIAL STUDIES</a></span>
...
<?php } ?> 	                        
            ...
            <div class="small-11 columns">	
				...
				<div id="sidebar" class="small-12 medium-5 columns">
					...
					<h3><img class="left" style="max-width: 30px; margin-right: 5px;" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/lightbulb-studies.png"> Insights &amp; Resources</h3>
