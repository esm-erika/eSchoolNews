...
$postlink   = '<br /><a href="' . get_permalink() . '?src=sb">See the rest of the story at eSchoolNews.com</a><br /><br />';
...
>
  ...
  <!-- RSS feed defaults -->
	<channel>
		...
		<!-- Feed Logo (optional) -->
		<image>
			<url>http://www.eschoolnews.com/wp-content/themes/advanced-newspaper/images/eSNlogo.jpg</url>
			<title>
        ...
        <?php /* while( have_posts()) : the_post(); */ ?>
		 <?php $query = new WP_Query( 'cat=133' ); ?>
 <?php if ( $query->have_posts() ) : while ( $query->have_posts() ) : $query->the_post(); ?>

			<item>
				<title><?php the_title_rss(); ?></title>
				<link><?php the_permalink_rss(); ?>?src=sb</link>
				<guid isPermaLink="false"><?php the_guid(); ?>&amp;src=sb</guid>
				<author><?php $PageByLine=get_post_meta($post->ID, 'Byline', $single = true); echo $PageByLine;//the_author(); ?></author>
				<image>
